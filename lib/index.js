    ...
    function Switch(ID) {
        ...
        class VTRow extends React.Component {
            ...
            collect_h_tr(idx, val) {
                ...
                if (re_computed === 0) {
                    _computed_h += (val - row_height[idx]) || 0;
                }
                row_height[idx] = val;
        ...
        class VTWrapper extends React.Component {
            ...
            set_tr_cnt(n, id) {
                ...
                store.set(id, Object.assign({}, vals, { row_count: n, re_computed }));
            }
        }
...
function createVT(vt_opts) {
    ...
    store.set(id, Object.assign({}, vt_opts, inside, { height: vt_opts.height }));
    return inside;
}
